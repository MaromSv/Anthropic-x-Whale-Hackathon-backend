...
ESSENTIAL_TITLES: dict[str, str] = {
    ...
    "Trauma": "Trauma",
    "Hemorrhage": "Trauma",
    "Tourniquet (extremity)": "Trauma",
    "Wound care dressing basics": "Trauma",
    "Laceration": "Trauma",
    ...
    "Jellyfish sting": "Environmental",
    "Bees, wasps, ants": "Environmental",
    "Tick removal": "Environmental",
    "Insect bites": "Environmental",
    ...
    # --- Respiratory ---
    "Aspirated foreign body": "Respiratory",
    "Strangulation": "Respiratory",
